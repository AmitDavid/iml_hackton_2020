...
PATH_TO_10K_TRAIN_DATA = "../data/data1k.csv"
...
if __name__ == '__main__':
    ...
    # Load data
    print('load data')
    df = pd.read_csv(PATH_TO_10K_TRAIN_DATA,
    ...
    # Get reg model
    # reg_model = get_best_reg_model(X, y_type)
    ...
    mask = y_delay > 0
    mask2 = y_test_delay > 0
    print('run models')
    class_model = get_best_class_model(X_train[mask], y_train_type[mask], X_test[mask2], y_test_type[mask2])
